...
I'm not really sure what won my peers over in the end. I guess it was nice to visit someone's page and not get jumpscared by `Linkin_Park_-_In_The_End.mp3` auto-playing with no warning. Maybe receiving a "poke" was _just_ close enough to surreptitious flirting for the hormone-beleaguered dark passenger within. Maybe the uniform, minimalist design still felt fresh and futuristic back then, and not like the DMV waiting room it has since become.
...
If this feels dramatic to read, I urge you to read about [ICE's social media surveillance](https://www.wired.com/story/ice-social-media-surveillance-24-7-contract/), or literally anything about Minneapolis in the past month.


## Re-reification

![Screenshot of The Fellowhip of the Ring, Boromir ogling the Ring of Power](https://ozzy.sfo3.cdn.digitaloceanspaces.com/blog-assets/boromir.png) _"Palantir" used to mean something different, man._
...
However, I'm a <span class="h6 font-bold italic">technologist</span>, which is Californian for idiot. And I can't help but feel hopeful about the future of the internet.

[The indie web is seeing a renaissance](https://medium.com/@Nathans_Tweets/the-indie-web-is-leading-a-quiet-rebellion-against-big-tech-f53e32ad11a5). New decentralized social media standards like [Mastodon](https://mastodon.social/explore) and [the AT Protocol](https://atproto.com/articles/atproto-ethos) are gaining traction ([although I would mistrust the supposed "stewards" of the latter](https://plutopsyche.medium.com/blueskys-ceo-meltdown-how-leadership-continues-to-fail-its-most-marginalized-users-8bfa7a8824b4)). Anecodtally, my friends are making more intentional decisions about social media, if not actively seeking out or creating the spaces that keep them safe and celebrated.
...
Fundamentally, the public does not understand what a computer is. I don't blame them for that. The oldest generations of 2026 have had the misfortune of living through the most breakneck technological revolution of history, with the internet going [from 1% to 97% of telecom traffic in 17 years](https://www.science.org/doi/10.1126/science.1200970), too quickly for communications to keep up with innovation. And the youngest generations have grown up mired in Windows 10 and smartphone apps, sophisticated technology indeed, but with the edges sanded off and the hood bolted shut. User-friendly is, by definition, prohibitively difficult to tinker with.

Now in another world, this would all be fine. I have no idea how combustion engines work, but I can still ride the bus. However, no one is trying to sell me a new bus, and they're certainly not telling me the bus can write my emails or [raise my child](https://futurism.com/artificial-intelligence/sam-altman-caring-baby-impossible-without-chatgpt).
...
### Further Reading
- [The Internet Used to Be a Place - Sarah Davis Barker (YouTube)](https://www.youtube.com/watch?v=oYlcUbLAFmw)
- [Alison Gopnik, The Evolution of Human Intelligences (YouTube)](https://www.youtube.com/watch?v=CBmz3pFdK-4)
